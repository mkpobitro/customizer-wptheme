        ...
        <div class="col-md-12">
            <div class="mission section">
                <h1 class="heading" id="service-heading">
					<?php
					echo esc_html( get_theme_mod( 'cust_service_heading', __( 'Our Mission Statement', 'customizer' ) ) );
					//echo esc_html( get_option( 'cust_services_heading', __( 'Our Mission Statement', 'customizer' ) ) );
					?>
                </h1>

                <?php if( get_theme_mod( 'cust_service_display_subheading',1 ) ): ?>
                <p class="subheading">
                    <?php
                    echo esc_html(get_theme_mod('cust_service_subheading'),__('Lorem ipsum dolor sit amet, consectetur adipisicing elit. Amet animi dolorem eveniet harum ipsum necessitatibus nihil, pariatur praesentium quia voluptate.','customizer'));
                    ?>
                </p>
                <?php endif; ?>

                <?php $cust_column_row = get_theme_mod( 'cust_service_number_row','col-md-4' ); ?>
                <div class="row sub-section">
                    <div class="<?php echo esc_attr($cust_column_row) ?>">
                        <div class="service"> 
